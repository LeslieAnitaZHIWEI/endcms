<template>
  <div class="upload-container">
    ...
    >
      ...
      <div class="uploadIcon"  @click="showDialog">
    ...
    <el-input style="width:100px;" v-model="pWidth" placeholder="图片宽度"></el-input>
      <el-input style="width:100px;" v-model="pHeight" placeholder="图片高度"></el-input>
      </div>
...
fileFormData.append('file', item,this.files[0].name)
          allRequest.push(
             this.$http({
        ...
        // 分发事件
        this.$emit("success", {urlList,attr:{pWidth:this.pWidth,pHeight:this.pHeight}});
        this.pWidth=""
        this.pHeight=""
      } catch (error) {
